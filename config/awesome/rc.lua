...
-- Theme definition
local theme = gears.filesystem.get_configuration_dir() .. "/themes/gruvbox/theme.lua"
...
lain.widget.cal {
    notification_preset = {
        ...
        bg = beautiful.colors.linebackground,
    },
...
local tasklist_buttons = bindings.tasklist_mouse
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "dev", "web", "docs", "img", "fm", "conf"}, s, awful.layout.layouts[1])
