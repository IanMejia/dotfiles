...
bindings.keyboard = {
    global = gears.table.join(
        awful.key({ altmod,           }, "s",      hotkeys_popup.show_help,
        ...
        awful.key({ modkey,           }, "k",
            ...
            {description = "focus top", group = "client"}),

        awful.key({ modkey,           }, "j",
            function ()
                awful.client.focus.global_bydirection("down")
            end,
            {description = "focus bottom", group = "client"}),

        -- Standard program
        awful.key({ modkey,           }, "Return", function () awful.spawn(global.terminal) end,
                  {description = "open a terminal", group = "launcher"}),
        awful.key({ modkey }, "o", function () awful.spawn(global.browser)end,
                  {description = "open firefox", group = "launcher"}),
        awful.key({ modkey, altmod    }, "r", awesome.restart,
                  {description = "reload awesome", group = "awesome"}),
        awful.key({ modkey, altmod    }, "q", awesome.quit,
        ...
        awful.key({ altmod,           }, "space",  function () awful.layout.inc( 1)                end,
                  {description = "select next", group = "layout"}),
        awful.key({ altmod, "Shift"   }, "space",  function () awful.layout.inc(-1)                end,
        ...
        awful.key({ modkey }, "e", function() awful.spawn(global.explorer) end,
